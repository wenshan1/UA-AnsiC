    ...
    public static class RsaUtils
    {
        ...
        public static int GetSignatureLength(X509Certificate2 signingCertificate)
        {
            ...
            try
            {
                ...
                if (rsa == null)
                {
                    throw new ArgumentException("No public key for certificate.", "signingCertificate");
                }
                    ...
                    X509Certificate2 signingCertificate)
        {
            ...
            try
            {
                ...
                if (rsa == null)
                {
                    throw new ArgumentException("No private key for certificate.", "signingCertificate");
                }
